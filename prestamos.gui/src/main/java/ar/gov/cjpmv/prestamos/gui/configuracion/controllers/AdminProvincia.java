...
public class AdminProvincia {
	
	private PnlDchaConfiguracion vista;
	private String descripcion;
	private List<Provincia> modelo;
	...
	private void actualizarVista() {
		this.vista.getLblTitulo().setText("Provincias");
		this.vista.getTxtTitulo().setText("Configuración: Provincia");
	...
	private void actualizarModelo() {
		...
		this.modelo= provinciaDAO.findListaPronvincia(this.descripcion);
	}
	...
	private void agregar() {
		...
		controlador.setModelo(new AMProvinciaModel(this.provinciaDAO));		
		controlador.setTitulo("Agregar Provincia");
	...
	private void modificar() {
		Provincia locProvincia= (Provincia) this.vista.getLLista().getSelectedValue();
		ABMConfiguracionControllers controlador= new ABMConfiguracionControllers(null);
		controlador.setModelo(new AMProvinciaModel(this.provinciaDAO, locProvincia));		
		controlador.setTitulo("Editar Provincia: "+locProvincia.getNombre());
		controlador.setLabel("Nombre");
		controlador.setLocationRelativeTo(this.vista);
		controlador.setVisible(true);
		this.buscar();
	...
	private void eliminar() {
		try{
			Provincia locProvincia= (Provincia) this.vista.getLLista().getSelectedValue();
			String pMensaje= "¿Realmente desea eliminar la provincia "+locProvincia+"?";
			String pTitulo= "Eliminar Provincia";
			...
			if(locConfirm==JOptionPane.YES_OPTION){
				this.provinciaDAO.eliminar(locProvincia);
				this.buscar();
			}
		}
