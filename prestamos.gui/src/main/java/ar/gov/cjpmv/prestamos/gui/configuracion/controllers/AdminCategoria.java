...
import ar.gov.cjpmv.prestamos.gui.configuracion.models.AMCategoriaModel;
...
public class AdminCategoria{
	...
	private void actualizarVista() {
		this.vista.getLblTitulo().setText("Categorías");
		this.vista.getTxtTitulo().setText("Configuración: Categoría");
	...
	private void actualizarModelo() {
		...
		//this.modelo= categoriaDAO.findListaCategoria(this.descripcion);
	}
	...
	private void agregar() {
		...
		controlador.setModelo(new AMCategoriaModel(this.categoriaDAO));		
		controlador.setTitulo("Agregar Categoría");
	...
	private void modificar() {
		Categoria locCategoria= (Categoria) this.vista.getLLista().getSelectedValue();
		ABMConfiguracionControllers controlador= new ABMConfiguracionControllers(null);
		controlador.setModelo(new AMCategoriaModel(this.categoriaDAO, locCategoria));		
		controlador.setTitulo("Editar Categoria: "+locCategoria.getNombre());
		controlador.setLocationRelativeTo(this.vista);
		controlador.setVisible(true);
		this.buscar();
	}
	...
	private void eliminar() {
		try{
			Categoria locCategoria= (Categoria) this.vista.getLLista().getSelectedValue();
			String pMensaje= "¿Realmente desea eliminar la categoría "+locCategoria+"?";
			String pTitulo= "Eliminar Categoría";
			...
			if(locConfirm==JOptionPane.YES_OPTION){
				this.categoriaDAO.eliminar(locCategoria);
				this.buscar();
			}
		}
